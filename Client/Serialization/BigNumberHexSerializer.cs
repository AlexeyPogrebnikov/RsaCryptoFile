...
{
	internal class BigNumberHexSerializer : IBigNumberSerializer
	{
		...
		public BigNumber Deserialize(string line)
		{
			...
			{
				int first = GetValue(line[line.Length - 2 * i - 1]);
				int second = GetValue(line[line.Length - 2 * i - 2]);
