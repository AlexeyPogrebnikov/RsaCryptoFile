...
namespace CryptoFile.Client.Controls {
	partial class FilesView : UserControl, IFilesView {
		...
		public void ResizeColumns() {
			...
			for (var i = 0; i < listView.Columns.Count; ++i) {
				...
				var width = Convert.ToInt32(graphics.MeasureString(column.Text, listView.Font).Width) + 45;
		...
		public bool OpenDirectoryEnabled {
			get { return openToolStripMenuItem.Enabled; }
